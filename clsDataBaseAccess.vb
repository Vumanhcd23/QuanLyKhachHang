...
Public Class DataBaseAccess
    ...
    Protected Sqldreader As SqlDataReaderáddddddddddddd
    ' Represents a set of data commands and a database jhjkhfff
    ...
    Private connectionstring As String = "Data Source=LAB204_19\MISASME2012;Initial Catalog=QUANLYKHACHHANG;Integrated Security=True"
